...
vuln_class: SSRF
source_url: X post high-signal list (real hunter)
source_author: @theXSSrat (X hunter thread)
source_date: 2025-06
...
# Blind SSRF via DNS in PDF Generator of SaaS Export Feature

## 核心思路

OOB DNS callback from PDF metadata parser using Interactsh
...
- 来源要点：Niche blind SSRF in 2025 SaaS export features still leaks cloud metadata
- 适用场景：SaaS export/API
...
- 本条技巧的价值点：Niche blind SSRF in 2025 SaaS export features still leaks cloud metadata
...
- X post high-signal list (real hunter)
