...
vuln_class: IDOR
source_url: https://infosecwriteups.com/finding-an-idor-in-user-profile-api-a-15-000-journey-to-critical-0f05e583c00b
...
# Derived technique from case: Finding an IDOR in User Profile API: A $15,000 Journey to Critical

## 核心思路

Direct": - /url: https://infosecwriteups.com/finding-an-idor-in-user-profile-api-a-15-000-journey-to-critical-0f05e583c00b§IDOR§Direct - text: user ID reference in profile API endpoint without ownership/tenant check
...
- 来源要点：Classic IDOR enables full unauthorized profile view/edit/delete in modern multi-tenant SaaS user APIs
- 适用场景：SaaS API
...
- 本条技巧的价值点：Classic IDOR enables full unauthorized profile view/edit/delete in modern multi-tenant SaaS user APIs
