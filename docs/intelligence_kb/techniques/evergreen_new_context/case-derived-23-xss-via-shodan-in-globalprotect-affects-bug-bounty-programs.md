...
vuln_class: XSS
source_url: https://ch4ndan.medium.com/how-i-found-xss-cve-2025-0133-using-shodan-39a37eae7807
source_author: @nav1n0x / ch4ndan
source_date: 2025-06
...
# Derived technique from case: XSS via Shodan in GlobalProtect (Affects Bug Bounty Programs)

## 核心思路

PoC": - /url: https://ch4ndan.medium.com/how-i-found-xss-cve-2025-0133-using-shodan-39a37eae7807§XSS§PoC - text: "payload in vulnerable GlobalProtect instances via Shodan
...
- 来源要点：Classic XSS scales via recon in enterprise SaaS/VPN contexts 2025
- 适用场景：Enterprise SaaS
...
- 本条技巧的价值点：Classic XSS scales via recon in enterprise SaaS/VPN contexts 2025
