...
vuln_class: IDOR
source_url: https://medium.com/@tinopreter/500-for-a-uuid-swap-i-almost-gave-up-on-this-idor-ae7a0adb518d
...
# Derived technique from case: IDOR in Multi-Tenant API via UUID Swap in Device Info Endpoint

## 核心思路

Switch": - /url: https://medium.com/@tinopreter/500-for-a-uuid-swap-i-almost-gave-up-on-this-idor-ae7a0adb518d§IDOR§Switch - text: to alternate /members/<UUID>/trusted-devices/info after JS recon
...
- 来源要点：IDOR survives UUIDs in SaaS tenant isolation via endpoint variation
- 适用场景：SaaS API
...
- 本条技巧的价值点：IDOR survives UUIDs in SaaS tenant isolation via endpoint variation
