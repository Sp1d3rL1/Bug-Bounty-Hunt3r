...
# Derived technique from case: Unauthenticated SSRF via Public Reference API Sharing Token Bypass

## 核心思路

Bypass": - /url: https://www.redpacketsecurity.com/hackerone-bugbounty-disclosure-unauthenticated-ssrf-via-public-reference-api-sharing-token-bypass-eclipse/§SSRF§Bypass - text: sharing token validation to trigger internal requests
...
- 来源要点：Classic unauth SSRF in public API sharing features of SaaS tools
- 适用场景：SaaS/API
...
- 本条技巧的价值点：Classic unauth SSRF in public API sharing features of SaaS tools
