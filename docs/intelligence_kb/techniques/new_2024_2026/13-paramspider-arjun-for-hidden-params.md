...
# ParamSpider + Arjun for hidden params

## 核心思路

paramspider -d target + arjun -u url -m JSON
...
- 来源要点：Discovers query/body params from archives for input-based vulns in authorized BB
- 适用场景：web apps
...
- 本条技巧的价值点：Discovers query/body params from archives for input-based vulns in authorized BB
