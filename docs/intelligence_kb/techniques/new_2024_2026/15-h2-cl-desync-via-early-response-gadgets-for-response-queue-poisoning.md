...
source_author: James Kettle (PortSwigger)
source_date: 2025-01
...
# H2.CL Desync via Early-Response Gadgets for Response Queue Poisoning

## 核心思路

Leverage Expect quirks + 0.CL deadlocks for double-desync enabling cross-tenant cache hijack
...
- 来源要点：Turns desync into reliable queue poisoning; $350k+ collective BB impact 2025
- 适用场景：modern H2/H1 downgrade stacks
...
- 本条技巧的价值点：Turns desync into reliable queue poisoning; $350k+ collective BB impact 2025
