...
source_url: https://medium.com/@Obfuscator/same-origin-policy-and-postmessage-510214960605
source_author: Aditya Bhatt (Stackademic)
source_date: 2025-12
...
risk_level: medium
target_types:
  - web apps (login flows)
---

# postMessage CSRF via No Origin Check + innerHTML Sink

## 核心思路

Iframe": - /url: https://medium.com/@Obfuscator/same-origin-policy-and-postmessage-510214960605§postMessage§Iframe - text: onload sends postMessage with payload to target window.innerHTML
...
- 来源要点：Real disclosed BB example (Upserve/Grammarly patterns); authorized testing
- 适用场景：web apps (login flows)
...
- 本条技巧的价值点：Real disclosed BB example (Upserve/Grammarly patterns); authorized testing
