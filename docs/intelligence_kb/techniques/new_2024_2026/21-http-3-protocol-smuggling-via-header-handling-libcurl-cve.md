...
source_url: https://hackerone.com/reports/3479203
source_author: curl team / BB reporter
...
# HTTP/3 Protocol Smuggling via Header Handling (libcurl CVE)

## 核心思路

Fundamental flaw in QUIC response headers across backends enables smuggling
...
- 来源要点：Practical for H3 downgrade scenarios in client-side BB testing
- 适用场景：libcurl HTTP/3 implementations
...
- 本条技巧的价值点：Practical for H3 downgrade scenarios in client-side BB testing
