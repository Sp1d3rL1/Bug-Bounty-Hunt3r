...
# Archive + GF patterns for sensitive files

## 核心思路

gau target | gf sensitive | grep -E '.(env|json|bak|zip)'
...
- 来源要点：Mines wayback for leaked configs/creds/files leading to immediate high-sev bugs in BB
- 适用场景：web apps
...
- 本条技巧的价值点：Mines wayback for leaked configs/creds/files leading to immediate high-sev bugs in BB
