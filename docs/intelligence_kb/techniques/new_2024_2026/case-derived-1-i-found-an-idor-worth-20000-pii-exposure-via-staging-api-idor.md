...
# Derived technique from case: I Found an IDOR Worth $20000 - PII Exposure via Staging API IDOR
...
- 来源要点：Mass PII exposure across real users in authorized BB program yields high bounty
- 适用场景：API endpoint in web app
...
- 本条技巧的价值点：Mass PII exposure across real users in authorized BB program yields high bounty
