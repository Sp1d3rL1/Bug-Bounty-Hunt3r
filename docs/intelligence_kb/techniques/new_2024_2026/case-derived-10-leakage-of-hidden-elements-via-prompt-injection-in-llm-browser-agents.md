...
risk_level: high
target_types:
  - LLM browser agents SaaS
---

# Derived technique from case: Leakage of Hidden Elements via Prompt Injection in LLM Browser Agents

## 核心思路

PI forces browser agent to leak hidden DOM elements/secrets from visited pages
...
- 来源要点：Demonstrates tool-calling abuse in browser-integrated LLM agents; authorized Huntr disclosure
- 适用场景：LLM browser agents SaaS
...
- 本条技巧的价值点：Demonstrates tool-calling abuse in browser-integrated LLM agents; authorized Huntr disclosure
