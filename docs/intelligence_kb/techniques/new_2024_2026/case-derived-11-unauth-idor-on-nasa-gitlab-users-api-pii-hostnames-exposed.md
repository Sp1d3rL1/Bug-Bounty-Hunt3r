...
source_url: https://www.bugcrowd.com
source_author: Bugcrowd hunter (anon)
...
# Derived technique from case: Unauth IDOR on NASA GitLab Users API - PII + Hostnames Exposed

## 核心思路

Direct /users/{id} API access without auth leaking internal data
...
- 来源要点：High-signal gov-adjacent BB disclosure; shows IDOR in GitLab-like instances
- 适用场景：GitLab-style API
...
- 本条技巧的价值点：High-signal gov-adjacent BB disclosure; shows IDOR in GitLab-like instances
