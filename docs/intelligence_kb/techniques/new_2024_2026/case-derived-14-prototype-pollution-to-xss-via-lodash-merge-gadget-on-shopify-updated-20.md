...
# Derived technique from case: Prototype Pollution to XSS via lodash merge gadget on Shopify (updated 2024 chain)
...
- 来源要点：Classic gadget still yielding BB in 2024+; client-side focus per authorized reports
- 适用场景：web apps using lodash
...
- 本条技巧的价值点：Classic gadget still yielding BB in 2024+; client-side focus per authorized reports
