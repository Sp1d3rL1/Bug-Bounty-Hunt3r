...
source_url: https://x.com/al1enr00t/status/2050323911317819496
source_author: al1enr00t
...
# Derived technique from case: OTP QR Link Base64 IDOR - Admin Session Hijack via Employer Portal

## 核心思路

Decode Base64 in OTP QR and swap ID param for admin access
...
- 来源要点：Logic corruption + IDOR chain in password recovery flow; niche QR/portal trick
- 适用场景：Portal API
...
- 本条技巧的价值点：Logic corruption + IDOR chain in password recovery flow; niche QR/portal trick
