...
# Derived technique from case: $5500 recon-only bug via passive enum to internal config
...
- 来源要点：Passive recon alone uncovered creds/AWS keys in forgotten internal subdomain on BB program
- 适用场景：web apps internal
...
- 本条技巧的价值点：Passive recon alone uncovered creds/AWS keys in forgotten internal subdomain on BB program
