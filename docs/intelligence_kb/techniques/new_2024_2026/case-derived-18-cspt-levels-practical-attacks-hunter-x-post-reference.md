...
# Derived technique from case: CSPT Levels & Practical Attacks (hunter X post reference)
...
- 来源要点：Niche technique shared by hunter; used in real BB chains
- 适用场景：web apps
...
- 本条技巧的价值点：Niche technique shared by hunter; used in real BB chains
