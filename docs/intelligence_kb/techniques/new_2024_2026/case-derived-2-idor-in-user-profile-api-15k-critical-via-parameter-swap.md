...
# Derived technique from case: IDOR in User Profile API - $15k Critical via Parameter Swap

## 核心思路

Change userID param in authenticated /api/profile/{id} to access/edit/delete any profile
...
- 来源要点：Critical impact (view/modify any user data) in real BB program demonstrates object-level bypass
- 适用场景：User profile API
...
- 本条技巧的价值点：Critical impact (view/modify any user data) in real BB program demonstrates object-level bypass
