...
source_url: https://x.com/rebane2001/status/1969305236817776911
source_author: Rebane (@rebane2001)
source_date: 2025-09
...
# Derived technique from case: Fastmail DOMPurify BB Sponsorship + CSS Sanitizer Bug (hunter report)

## 核心思路

Responsive": - /url: https://x.com/rebane2001/status/1969305236817776911§DOMPurify§Responsive - text: BB fix in <6h + sponsor of DOMPurify BB

## 前置条件

- 目标明确在授权 Bug Bounty scope 内，且 rules 未禁止该测试类别。
- 存在与 `DOMPurify` 相关的业务对象、接口、前端入口或集成链路。
- 使用自有测试账号、测试租户、sandbox 或平台允许的测试数据。
- 如果涉及支付/账号/隐私/生产状态变化，必须先确认项目允许并采用最小影响验证。

## 完整技法细节

- 来源要点：Highlights real hunter interaction with authorized program sponsoring sanitizer research
- 适用场景：email/web service
...
- 本条技巧的价值点：Highlights real hunter interaction with authorized program sponsoring sanitizer research
...
- https://x.com/rebane2001/status/1969305236817776911
