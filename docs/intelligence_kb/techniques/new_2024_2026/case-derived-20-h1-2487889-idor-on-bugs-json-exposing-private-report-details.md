...
# Derived technique from case: H1 #2487889 - IDOR on /bugs.json Exposing Private Report Details
...
- 来源要点：JSON endpoint IDOR in bug tracker; cross-org leakage in authorized program
- 适用场景：Bug tracking API
...
- 本条技巧的价值点：JSON endpoint IDOR in bug tracker; cross-org leakage in authorized program
