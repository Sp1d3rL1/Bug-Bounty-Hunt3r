...
vuln_class: CSPT
source_url: https://x.com/HusseiN98D/status/1809164551822172616
source_author: Hussein Daher (@HusseiN98D)
source_date: 2024
...
# Derived technique from case: CSPT to JSONP XSS (hunter X report)

## 核心思路

Path traversal redirects fetch to JSONP endpoint
...
- 来源要点：Niche CSPT->JSONP chain yielding XSS in BB; authorized
- 适用场景：web apps
...
- 本条技巧的价值点：Niche CSPT->JSONP chain yielding XSS in BB; authorized
