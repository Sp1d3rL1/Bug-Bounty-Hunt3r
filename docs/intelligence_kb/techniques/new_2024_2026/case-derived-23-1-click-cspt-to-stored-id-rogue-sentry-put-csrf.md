...
# Derived technique from case: 1-Click CSPT to Stored ID Rogue Sentry PUT CSRF
...
- 来源要点：Practical one-click CSRF via client path control; real BB impact
- 适用场景：monitoring tools
...
- 本条技巧的价值点：Practical one-click CSRF via client path control; real BB impact
