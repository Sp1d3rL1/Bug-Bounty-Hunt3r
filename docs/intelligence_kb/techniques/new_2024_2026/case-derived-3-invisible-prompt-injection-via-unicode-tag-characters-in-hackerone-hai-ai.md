...
# Derived technique from case: Invisible Prompt Injection via Unicode Tag Characters in HackerOne Hai AI Assistant
...
- 来源要点：Stealth context poisoning in bug bounty AI triage tools; LLM decodes hidden text humans miss; valid medium severity in authorized HackerOne beta
- 适用场景：HackerOne Hai AI SaaS triage tool
...
- 本条技巧的价值点：Stealth context poisoning in bug bounty AI triage tools; LLM decodes hidden text humans miss; valid medium severity in authorized HackerOne beta
