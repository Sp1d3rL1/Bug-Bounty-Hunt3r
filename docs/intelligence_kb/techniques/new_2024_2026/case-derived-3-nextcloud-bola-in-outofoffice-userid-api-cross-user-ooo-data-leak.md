...
# Derived technique from case: Nextcloud BOLA in /outOfOffice/{userId} API - Cross-User OOO Data Leak
...
- 来源要点：Bypasses tenant isolation in multi-user collab app; real H1 disclosure by hunter
- 适用场景：Nextcloud API
...
- 本条技巧的价值点：Bypasses tenant isolation in multi-user collab app; real H1 disclosure by hunter
