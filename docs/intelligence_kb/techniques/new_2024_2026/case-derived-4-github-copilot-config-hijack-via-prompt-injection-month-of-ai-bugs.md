...
# Derived technique from case: GitHub Copilot Config Hijack via Prompt Injection (Month of AI Bugs)
...
- 来源要点：Turns coding agent into RAT; part of authorized Month of AI Bugs disclosures; shows config/tool abuse in IDE SaaS
- 适用场景：GitHub Copilot SaaS
...
- 本条技巧的价值点：Turns coding agent into RAT; part of authorized Month of AI Bugs disclosures; shows config/tool abuse in IDE SaaS
