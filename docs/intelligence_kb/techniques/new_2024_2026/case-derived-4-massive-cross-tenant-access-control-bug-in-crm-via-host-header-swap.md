...
# Derived technique from case: Massive Cross-Tenant Access Control Bug in CRM via Host Header Swap
...
- 来源要点：Reveals inconsistent tenant isolation per role allowing full cross-org data access/edit
- 适用场景：SaaS CRM multi-tenant
...
- 本条技巧的价值点：Reveals inconsistent tenant isolation per role allowing full cross-org data access/edit
