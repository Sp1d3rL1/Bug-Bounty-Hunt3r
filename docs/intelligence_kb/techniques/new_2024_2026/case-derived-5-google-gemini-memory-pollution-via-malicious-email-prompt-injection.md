...
# Derived technique from case: Google Gemini Memory Pollution via Malicious Email Prompt Injection
...
- 来源要点：$15k Google VRP bounty; demonstrates persistent state manipulation in SaaS LLM agents; authorized VRP environment
- 适用场景：Google Gemini SaaS
...
- 本条技巧的价值点：$15k Google VRP bounty; demonstrates persistent state manipulation in SaaS LLM agents; authorized VRP environment
