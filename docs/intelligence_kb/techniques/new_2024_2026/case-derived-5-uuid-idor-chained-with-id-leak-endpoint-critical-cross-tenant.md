...
# Derived technique from case: UUID IDOR Chained with ID Leak Endpoint - Critical Cross-Tenant
...
- 来源要点：Combines enumeration + object ref bypass; turns low to critical in authorized hunt
- 适用场景：Multi-tenant API
...
- 本条技巧的价值点：Combines enumeration + object ref bypass; turns low to critical in authorized hunt
