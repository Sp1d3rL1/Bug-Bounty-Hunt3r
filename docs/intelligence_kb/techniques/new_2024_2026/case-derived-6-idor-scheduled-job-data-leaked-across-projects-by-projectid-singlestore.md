...
# Derived technique from case: IDOR → Scheduled Job Data Leaked Across Projects by projectID (SingleStore)
...
- 来源要点：Exposes internal job artifacts in BB-authorized env; practical multi-project bypass
- 适用场景：API in SaaS platform
...
- 本条技巧的价值点：Exposes internal job artifacts in BB-authorized env; practical multi-project bypass
