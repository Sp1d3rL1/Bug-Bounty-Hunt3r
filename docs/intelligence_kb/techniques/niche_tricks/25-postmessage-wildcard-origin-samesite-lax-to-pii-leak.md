...
- 来源要点：Leads to data exfil in auth widgets; high-signal overlooked BB class
- 适用场景：web apps (widgets/extensions)
...
- 本条技巧的价值点：Leads to data exfil in auth widgets; high-signal overlooked BB class
