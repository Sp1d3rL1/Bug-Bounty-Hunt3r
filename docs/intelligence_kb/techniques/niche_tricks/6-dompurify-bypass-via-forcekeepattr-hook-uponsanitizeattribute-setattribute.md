...
- 来源要点：Chains with session fixation for ATO in subdomain XSS; real BB chain on authorized program
- 适用场景：web apps using DOMPurify
...
- 本条技巧的价值点：Chains with session fixation for ATO in subdomain XSS; real BB chain on authorized program
