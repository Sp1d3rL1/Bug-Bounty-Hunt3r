...
risk_level: medium
target_types:
  - AI tools like AutoGPT
---

# Derived technique from case: AutoGPT SSRF Protection Bypass to Internal Services

## 核心思路

Bypass": - /url: https://joshua.hu/2025-bug-bounty-stories-fail§SSRF§Bypass - text: SSRF filters in AutoGPT allowing outbound to internal services
...
- 来源要点：Enables recon/data exfil in AI/LLM tools; reported via huntr
- 适用场景：AI tools like AutoGPT
...
- 本条技巧的价值点：Enables recon/data exfil in AI/LLM tools; reported via huntr
