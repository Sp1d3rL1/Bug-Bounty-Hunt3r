...
# Derived technique from case: DOMPurify 3.1.3-3.1.5 Bypass via Unicode Normalization + toUpperCase() Context Switch
...
- 来源要点：Triggers mXSS in apps re-parsing output; fixed after researcher disclosure
- 适用场景：client-side sanitizers
...
- 本条技巧的价值点：Triggers mXSS in apps re-parsing output; fixed after researcher disclosure
