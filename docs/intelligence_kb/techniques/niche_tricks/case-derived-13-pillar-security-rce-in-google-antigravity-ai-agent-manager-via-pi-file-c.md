...
# Derived technique from case: Pillar Security RCE in Google Antigravity AI Agent Manager via PI + File Creation Tools
...
- 来源要点：Bypassed highest security settings in authorized Google VRP; tool chaining abuse
- 适用场景：Google Antigravity AI agent SaaS
...
- 本条技巧的价值点：Bypassed highest security settings in authorized Google VRP; tool chaining abuse
