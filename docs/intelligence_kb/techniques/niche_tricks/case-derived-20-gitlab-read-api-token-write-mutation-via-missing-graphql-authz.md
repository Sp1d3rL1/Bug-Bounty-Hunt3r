...
# Derived technique from case: GitLab read_api Token Write Mutation via Missing GraphQL Authz
...
- 来源要点：Exploits missing GraphQL layer checks despite REST auth in BB/hunts
- 适用场景：GitLab GraphQL API
...
- 本条技巧的价值点：Exploits missing GraphQL layer checks despite REST auth in BB/hunts
