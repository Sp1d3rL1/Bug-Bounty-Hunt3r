...
# Derived technique from case: Web Cache Deception: When a 404 Still Leaks Sensitive Data
...
- 来源要点：Leaks emails/names/auth details cross-user via cached 404; first real BB report (dup but high signal)
- 适用场景：real bug bounty target with profile paths
...
- 本条技巧的价值点：Leaks emails/names/auth details cross-user via cached 404; first real BB report (dup but high signal)
