...
# Derived technique from case: GitHub Hidden Unicode Bypass of UTF Warning Filter
...
- 来源要点：Evades security filter allowing code injection in Node.js repos; visible only via sed -n l
- 适用场景：GitHub code UI
...
- 本条技巧的价值点：Evades security filter allowing code injection in Node.js repos; visible only via sed -n l
