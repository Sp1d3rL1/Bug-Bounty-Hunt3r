...
# Derived technique from case: From IDOR to Bypass: Fixed Bug Still Exposed 6.4M Users Data (Part 2)
...
- 来源要点：Demonstrates incomplete fixes leave edge vectors; real large-scale impact
- 适用场景：User data API
...
- 本条技巧的价值点：Demonstrates incomplete fixes leave edge vectors; real large-scale impact
